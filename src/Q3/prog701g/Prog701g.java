...
public class Prog701g {
    public static void main(String[] args) {
        try{
            ...
            int totstus =0;
            String large = "";
            String small = "adasdasdassssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssdeufhoewghfrouaygewoufygewfhewsjkfgaoewuygfaouyewgfouaywegofuyagweofygwoueygfowauyegfrouyegwofuygaewoufy";
